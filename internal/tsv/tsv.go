// Package tsv encodes values for usage in LOAD DATA INFILE's tab separated values.
//
// This package was originally adapted from github.com/hexon/mysqltsv (BSD-2-Clause).
// See LICENSE in this directory for the original license and attribution.
package tsv
